<script type="text/javascript">
    $(document).ready(function() {
        var dataTable = $('#example').DataTable({
            "ajax": {
                "url": "{{ route('getpendingAllListRead') }}",
                "type": "GET",
            },
            responsive: true,
            lengthChange: true,
            ...
            "columns": [
                ...
                {data: 'pstatus',
                        ...
                        switch(parseInt(data)) {
                            ...
                            case 6:
                                return '<span class="badge badge-success">Pending in Budget Office</span>';
                            default:
                ...
                {data: 'pid',
                    render: function(data, type, row) {
                        if (type === 'display') {
                            var link = '<a href="' + pendingAllListViewRoute + '/' + data + '" class="btn btn-default btn-xs btn-edit">' +
